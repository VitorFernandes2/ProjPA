...
public class CrewMember2ChooseRoom extends StackPane implements Constants,PropertyChangeListener{
    
    private GameLogic game;
    
    public CrewMember2ChooseRoom(GameLogic Game) {
        this.game = Game;
        ...
        Label lblChooseRooms = new Label("Choose Crew Member 2 Room");
    ...
    public void propertyChange(PropertyChangeEvent evt) {
            ...
            setVisible(this.game.inAwaitThirdTokenSecondCrewMember());
